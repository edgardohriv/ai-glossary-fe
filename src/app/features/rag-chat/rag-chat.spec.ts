...
import { of } from 'rxjs';
import { RagChatComponent } from './rag-chat';
...
describe('RagChatComponent', () => {
  beforeEach(async () => {
    ...
    const service = TestBed.inject(RagChatService);
    vi.spyOn(service, 'sendMessage').mockResolvedValue(of('Hello'));
  });

  it('should create the component', () => {
    const fixture = TestBed.createComponent(RagChatComponent);
  ...
  it('onSend() should call ragChatService.sendMessage', async () => {
    const fixture = TestBed.createComponent(RagChatComponent);
    const service = TestBed.inject(RagChatService);
    const component = fixture.componentInstance as unknown as {
      inputValue: { set: (v: string) => void };
